...
public class testFourProcessEvidence extends UiBase {
    ...
    public void test1SelectSearch(){
         try{
             ...
             Thread.sleep(200);
             this.information3 = driver.findElement(By.xpath("/html/body/div[3]/div[1]/div[1]/ul/li[2]/span")).getText();
             ...
             this.information1 = driver.findElement(By.xpath("//*[@id=\"app\"]/div/div[2]/div/div/div[2]/div[2]/div[1]/div[3]/table/tbody/tr[1]/td[7]/div/div/span")).getText();
